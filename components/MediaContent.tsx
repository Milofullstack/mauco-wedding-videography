    ...
    <section className="w-full h-full xl:h-dvh bg-[#f9f4f2]">
      <div className="w-full h-full flex flex-col-reverse px-8 md:px-16 lg:px-10 xl:flex-row-reverse  items-center justify-center gap-4 md:gap-0">
        ...
        <div className="w-full h-full lg:h-dvh  lg:px-8 xl:px-2 2xl:px-6 pt-0 xl:py-8 xl:w-2/3  flex flex-col gap-10 md:gap-20 lg:gap-10  justify-evenly  items-center">
          ...
          <p className="[font-family:var(--font-cormorant)] text-center font-lnormal  text-xl md:text-3xl lg:text-2xl xl:text-2xl 2xl:text-lg text-gray-700">
            I offer dedicated{" "}
            <span className="font-bold">Media Content Packages</span> for
            couples who want their wedding day to be felt, not just remembered.
            I create vertical content made for Instagram, TikTok, and every
            place where your story continues.
            <br />
            <br />
            Whether you already have a photographer or not, these packages fit
            seamlessly into your wedding coverage. And while traditional edits
            take time, my vertical clips are delivered{" "}
            <span className="font-bold">within 24 hours</span> —ready to share
            the very next day. I work alongside your team or independently,
            capturing emotion, atmosphere, and the brief moments that become
            unforgettable.
            <br />
            <br />
